...
class GraphExtractor:
    ...
    async def __call__(
        ...
        print("hahahahahah i am called hahahacxxxxxxxxxxxxxxxxxxx")
        ...
        for source_doc_id, extracted_data in results.items():
            ...
            for record in records:
                ...
                if (
                    ...
                    timestampe = clean_str(record_attributes[4].upper())
                    name = clean_str(record_attributes[5].upper())
                    edge_name_timestamp = f"{name}@{timestampe}"
                    ...
                    graph.add_edge(
                        ...
                        source_id=edge_source_id,
                        edge_name_timestamp=edge_name_timestamp,
                    )
