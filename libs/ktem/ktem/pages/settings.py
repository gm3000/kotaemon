...
class SettingsPage(BasePage):
    ...
    **IMPORTANT**: the name and id of the UI setting components should match the
    ...
    def index_tab(self):
        ...
        with gr.Tab("Retrieval settings", visible=self._render_index_tab) as self.ret_tab:
    ...
    def reasoning_tab(self):
        with gr.Tab("Reasoning settings", visible=self._render_reasoning_tab) as self.rea_tab:
            with gr.Group():
