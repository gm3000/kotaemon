...
settings = {"logged_in": False, "selected_file_id": None, "session_id": None}
...
def pick_file():
    ...
    all_files_option_test = "\n".join(
        [
            f"{index}. {value[1]} {value[2]} {value[5]}"
...
def init_session():
    result_chat = client.predict(
        chat_input="blablabla",
        chat_history=None,
        conv_name=None,
        api_name="/submit_msg",
    )
